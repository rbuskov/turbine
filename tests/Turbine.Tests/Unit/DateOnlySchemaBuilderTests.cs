...
public class DateOnlySchemaBuilderTests
{
    private static (DateOnlySchema schema, DateOnlySchemaBuilder builder) Subject()
    {
        var schema = new DateOnlySchema();
        return (schema, new DateOnlySchemaBuilder(schema));
    }
